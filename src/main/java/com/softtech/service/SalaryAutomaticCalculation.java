...
public interface SalaryAutomaticCalculation {
    ...
    *@date:2022/08/30
    */
    String getAgeByEmployeeID(String employeeID);
     ...
     *@date:2022/08/30
     */
    List<WelfarefeeInfoEntity> getStandSalaryByEmployeeID(String employeeID);
     ...
     *@date:2022/08/30
     */
    List<BaseSalaryInfoEntity> getBaseSalaryAndOvertimePayAndInsufficienttimePayByEmployeeID(String employeeID);

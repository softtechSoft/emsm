 ...
 * @return:
 */
public class HoldingTaxInfoFormBean {
    //社員ID
    ...
    //所得税
    @NotEmpty(message = "一月所得税を入力してください。")
    @Pattern(message = "一月所得税に数値のみを入力してください。", regexp = "^[0-9]*$")
    private String incomeTax1;
    @NotEmpty(message = "二月所得税を入力してください。")
    @Pattern(message = "二月所得税に数値のみを入力してください。", regexp = "^[0-9]*$")
    private String incomeTax2;
    @NotEmpty(message = "三月所得税を入力してください。")
    @Pattern(message = "三月所得税に数値のみを入力してください。", regexp = "^[0-9]*$")
    private String incomeTax3;
    @NotEmpty(message = "四月所得税を入力してください。")
    @Pattern(message = "四月所得税に数値のみを入力してください。", regexp = "^[0-9]*$")
    private String incomeTax4;
    @NotEmpty(message = "五月所得税を入力してください。")
    @Pattern(message = "五月所得税に数値のみを入力してください。", regexp = "^[0-9]*$")
    private String incomeTax5;
    @NotEmpty(message = "六月所得税を入力してください。")
    @Pattern(message = "六月所得税に数値のみを入力してください。", regexp = "^[0-9]*$")
    private String incomeTax6;
    @NotEmpty(message = "七月所得税を入力してください。")
    @Pattern(message = "七月所得税に数値のみを入力してください。", regexp = "^[0-9]*$")
    private String incomeTax7;
    @NotEmpty(message = "八月所得税を入力してください。")
    @Pattern(message = "八月所得税に数値のみを入力してください。", regexp = "^[0-9]*$")
    private String incomeTax8;
    @NotEmpty(message = "九月所得税を入力してください。")
    @Pattern(message = "九月所得税に数値のみを入力してください。", regexp = "^[0-9]*$")
    private String incomeTax9;
    @NotEmpty(message = "十月所得税を入力してください。")
    @Pattern(message = "十月所得税に数値のみを入力してください。", regexp = "^[0-9]*$")
    private String incomeTax10;
    @NotEmpty(message = "十一月所得税を入力してください。")
    @Pattern(message = "十一月所得税に数値のみを入力してください。", regexp = "^[0-9]*$")
    private String incomeTax11;
    @NotEmpty(message = "十二月所得税を入力してください。")
    @Pattern(message = "十二月所得税に数値のみを入力してください。", regexp = "^[0-9]*$")
    ...
    public void setHoldingTaxID(String incomeTaxID) {
        this.holdingTaxID = incomeTaxID;
    }

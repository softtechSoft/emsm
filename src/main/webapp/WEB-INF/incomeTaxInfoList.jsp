...
<form:form name="theForm" id="theForm" method="post" modelAttribute="incomeTaxInfoFormBean"
    ...
    <table border="1" class="incomeTaxInfoList-table">
        <tr>
            ...
            <th width="100">1月社宅家賃</th>
            <th width="100">2月社宅家賃</th>
            <th width="100">3月社宅家賃</th>
            <th width="100">4月社宅家賃</th>
            <th width="100">5月社宅家賃</th>
            <th width="100">6月社宅家賃</th>
            <th width="100">7月社宅家賃</th>
            <th width="100">8月社宅家賃</th>
            <th width="100">9月社宅家賃</th>
            <th width="100">10月社宅家賃</th>
            <th width="100">11月社宅家賃</th>
            <th width="100">12月社宅家賃</th>
            <th width="100">1月共益費</th>
            <th width="100">2月共益費</th>
            <th width="100">3月共益費</th>
            <th width="100">4月共益費</th>
            <th width="100">5月共益費</th>
            <th width="100">6月共益費</th>
            <th width="100">7月共益費</th>
            <th width="100">8月共益費</th>
            <th width="100">9月共益費</th>
            <th width="100">10月共益費</th>
            <th width="100">11月共益費</th>
            <th width="100">12月共益費</th>
        ...
        <c:forEach items="${list}" var="incomeTaxInfoList" varStatus="status">
            <tr <c:if test="${status.count%2==0}"> style="background-color:#bfe1ff"</c:if>
                ...
                <td><c:out value="${incomeTaxInfoList.employeeName}"/></td>
                ...
                <td><c:out value="${incomeTaxInfoList.rental01}"/></td>
                <td><c:out value="${incomeTaxInfoList.rental02}"/></td>
                <td><c:out value="${incomeTaxInfoList.rental03}"/></td>
                <td><c:out value="${incomeTaxInfoList.rental04}"/></td>
                <td><c:out value="${incomeTaxInfoList.rental05}"/></td>
                <td><c:out value="${incomeTaxInfoList.rental06}"/></td>
                <td><c:out value="${incomeTaxInfoList.rental07}"/></td>
                <td><c:out value="${incomeTaxInfoList.rental08}"/></td>
                <td><c:out value="${incomeTaxInfoList.rental09}"/></td>
                <td><c:out value="${incomeTaxInfoList.rental10}"/></td>
                <td><c:out value="${incomeTaxInfoList.rental11}"/></td>
                <td><c:out value="${incomeTaxInfoList.rental12}"/></td>
                <td><c:out value="${incomeTaxInfoList.rentalMgmtFee01}"/></td>
                <td><c:out value="${incomeTaxInfoList.rentalMgmtFee02}"/></td>
                <td><c:out value="${incomeTaxInfoList.rentalMgmtFee03}"/></td>
                <td><c:out value="${incomeTaxInfoList.rentalMgmtFee04}"/></td>
                <td><c:out value="${incomeTaxInfoList.rentalMgmtFee05}"/></td>
                <td><c:out value="${incomeTaxInfoList.rentalMgmtFee06}"/></td>
                <td><c:out value="${incomeTaxInfoList.rentalMgmtFee07}"/></td>
                <td><c:out value="${incomeTaxInfoList.rentalMgmtFee08}"/></td>
                <td><c:out value="${incomeTaxInfoList.rentalMgmtFee09}"/></td>
                <td><c:out value="${incomeTaxInfoList.rentalMgmtFee10}"/></td>
                <td><c:out value="${incomeTaxInfoList.rentalMgmtFee11}"/></td>
                <td><c:out value="${incomeTaxInfoList.rentalMgmtFee12}"/></td>

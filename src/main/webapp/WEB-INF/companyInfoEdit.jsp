...
<body>
<form:form name="theForm" id="theForm" method="post" modelAttribute="companyInfoBean"  action="updateCompany" >
				<h1>取引先情報更新</h1>
		<p style="color: red;">
		...
		<table  border="0">
			<tr>
				...
				<td width="200px" style="text-align: right;">
					<input type="button" id="Registration" name="Registration" value="更新"  onclick="doRegist()" /></td>
			</tr>
		</table>
